...
wind_us <- wind_us %>% 
  ...
  #case_when(status %in% c('Cancelled', 'Out of service (temporarily)', 'Standby', 'Decommissioned', 'Opertaing | Decommissioned')] ~ 'not_operating')

# case_when()


# need to remove NAs from wind_us -- in next chunk
```
